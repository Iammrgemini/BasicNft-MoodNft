...
contract MoodNft is ERC721 {
    ...
    constructor(
        ...
        string memory happySgvImageUri
    ) ERC721("MoodNft", "MNF") {
        s_tokenCounter = 0;
        s_sadSvgImageUri = sadSvgImageUri;
        s_happySvgImageUri = happySgvImageUri;
    }
                    ...
                    Base64.encode(
                        bytes(
                            abi.encodePacked(
                                '{"name": "',
                                name(),
                                '", "description": "An NFT that relects the owners mood.", "attributes": [{"trait_type": "moodiness", "value": 100}], "image": "',
                                imageURI,
                                '"}'
                            )
                        )
